...
void buildWeb(){
  ...
  webSite+="<title>Remote</title>\n";
  webSite+="<style>";
  webSite+="html{background-color:#e5e9dc;}";
  webSite+=".title{text-align:center;color:darkblue;}";
  webSite+="a{display:block;text-decoration:none;background-color:light-gray}"; 
  ...
  webSite+="/head>\n";
  webSite+="<body>";
  webSite+="<h1 class=\"title\">Remote Bitch</h1>";
  webSite+="<a class=\"btn1\" href=\"/H\">ON</a>";
  webSite+="<a class=\"btn2\" href=\"/L\">OFF</a>";
  webSite+="</body></html>";
  Serial.print("builWebSuccessful");
  }
